...
const WORD_BANK = [
  ...
  "before", "move", "right", "old", "same", "tell", "does", "set", "three",
  "air", "play", "small", "end", "put", "home", "read", "port", "spell",
  "add", "land", "must", "big", "such", "follow", "act", "why", "ask",
  "change", "went", "light", "kind", "off", "house", "try", "again",
  "animal", "point", "mother", "world", "near", "build", "self", "earth",
  "father", "head", "stand", "own", "page", "should", "country", "found",
  "answer", "school", "grow", "study", "still", "learn", "plant", "food",
