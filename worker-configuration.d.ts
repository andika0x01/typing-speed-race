/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5b0d7f9434d94dacab039ee141eb9e8)
// Runtime types generated with workerd@1.20260310.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "LeaderboardDO" | "GameSessionDO" | "DuelRoomDO";
	}
	interface Env {
		D1: D1Database;
		LEADERBOARD_DO: DurableObjectNamespace<import("./src/worker/index").LeaderboardDO>;
		GAME_SESSION_DO: DurableObjectNamespace<import("./src/worker/index").GameSessionDO>;
		DUEL_ROOM_DO: DurableObjectNamespace<import("./src/worker/index").DuelRoomDO>;
	}
}
